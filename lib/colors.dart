...
class AppColor{
  ...
  static Color gradientFirst = const Color(0xFF9C27B0);
  static Color gradientSecond = const Color(0xFFCE93D8);
  ...
  static Color secondPageContainerGradient1stColor = const Color(0xFFEA80FC);
  static Color secondPageContainerGradient2ndColor = const Color(0xFFCE93D8);
